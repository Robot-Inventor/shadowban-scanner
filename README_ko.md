...
X(구 Twitter)의 Shadowban을 감지하는 확장 기능입니다.
...
- 포스트 단위의 민감 정보 플래그를 감지합니다
- 포스트의 연령 제한을 감지합니다
- 숨겨진 포스트을 표시하는 버튼 추가

![계정 단위의 쉐도우밴 감지 스크린샷](doc/image/screenshot2_ko.png)

![포스트 단위의 쉐도우밴 감지 스크린샷](doc/image/screenshot1_ko.png)

![숨겨진 포스트 스크린샷](doc/image/screenshot3_ko.png)

## 정확도

계정 단위의 Shadowban 검출은 다른 많은 도구와 마찬가지로 가짜 양성 또는 가짜 음성이 발생할 수 있습니다. 반면에 포스트 단위의 민감 플래그와 연령 제한은 거의 완벽하게 검출할 수 있습니다. 따라서 Shadowban Scanner를 통해 계정이나 포스트의 상태를 지속적으로 확인하면서 다른 도구들도 함께 사용하는 것을 권장합니다.
