...
const materialSymbolsLicense: OSSLicenses[number] = {
    license: "Apache-2.0",
    licenseText: `
                                 Apache License
...
`,
    // Do not trim() the licenseText because it contains a lot of spaces.
    name: "Material Icons / Material Symbols",
    repository: "https://github.com/google/material-design-icons"
};

const additionalLicenses: OSSLicenses = [twemojiLicense, materialSymbolsLicense];
